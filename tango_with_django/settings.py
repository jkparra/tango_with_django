...
#NEVER FORGET / AT THE END AND BEGINNING OF URL DECLARATIONS
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.9/howto/deployment/checklist/
#variables for registration-redux app
REGISTRATION_OPEN=True
#One - week activation window.
ACCOUNT_ACTIVATION_DAYS=7
#If true user will be automatically logged -in
REGISTRATION_AUTO_LOGIN=True
#url to redirect when successfully logged in
LOGIN_REDIRECT_URL='/rango/'
#the page to redirect when trying to access restricted content./
LOGIN_URL='/accounts/login/'



# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'jy^&$d_yk37!+i84ii^if%4!%ksq=sld+#3=-ir=(+*3!mqh5&'

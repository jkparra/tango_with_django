...
url(r'^ensayopdf/$',views.ensayopdf,name='ensayopdf'),
url(r'^ensayopdf2/$',views.ensayopdf2,name='ensayopdf2'),
url(r'^ensayopdf21/$',views.ensayopdf21,name='ensayopdf21'),
url(r'^ensayopdf3/$',views.ensayopdf3,name='ensayopdf3'),
